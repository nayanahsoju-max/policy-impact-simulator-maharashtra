...
**User Flow:**
1. Select a district  
2. Choose a welfare program  
3. Adjust the budget cut percentage  
4. View computed impact and insights  
...
git clone https://github.com/nayanahsoju-max/policy-cut-simulator.git
...
For example:
- High ST population leads to greater reliance on public employment programs  
- High deprivation indicates limited fallback options  
- Low literacy reflects reduced adaptability to economic changes  
...
- Portfolio project showcasing full-stack and analytical skills  
...
This project reflects an effort to combine data science with public policy analysis, focusing on interpretability and real-world relevance. It demonstrates both technical implementation and the ability to model complex societal problems in a structured way.
